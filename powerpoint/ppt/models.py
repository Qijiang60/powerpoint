...
class Page(models.Model):
    ...
    img2 = models.CharField(u'图片2地址',max_length=200)
    img3 = models.CharField(u'图片3地址',max_length=200)
    img4 = models.CharField(u'图片4地址',max_length=200)
    img5 = models.CharField(u'图片5地址',max_length=200)
    img6 = models.CharField(u'图片6地址',max_length=200)
    img7 = models.CharField(u'图片7地址',max_length=200)
    img8 = models.CharField(u'图片8地址',max_length=200)
    img9 = models.CharField(u'图片9地址',max_length=200)
